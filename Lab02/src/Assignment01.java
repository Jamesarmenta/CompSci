...
/* MENU **************/
        ...
        if( menuAnswer == 8 ){System.out.println("File saved. Goodbye!"); 
        try {
...
//***DISPLAY LIST
	...
	public static void printListToFile(ArrayList<StudentScore> studentList) throws FileNotFoundException{
		...
		{
			//Open printer
			pw = new PrintWriter(new FileOutputStream("src/input.txt", true)); //true for append, false for overwrite
			
			System.out.println("");
			pw.print("Updated List:");
			for (int i=0; i<studentList.size(); i++){
