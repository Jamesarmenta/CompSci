 ...
 * @see http://www.dreamincode.net/forums/topic/196965-input-mismatch-exception-handling/
 */
...
/* QUESTION 2 **************/
        ...
        do{
        	...
        	try {
        		//Input from User
        		quest2 = input.nextInt();
        		//Re-prompt if not 1-4
        		if(quest2<1 || quest2>4) {
        			System.out.println("Invalid value! Please enter 1, 2, 3 or 4 for your answer.");
        		} else {
        			invalid2 = false;
        		}
...
/* QUESTION 4 **************/
        ...
        do{
        	...
        	try {
        		//Input from User
        		quest4 = input.nextInt();
        		//Re-prompt if not 1-4
        		if(quest4<1 || quest4>4) {
        			System.out.println("Invalid value! Please enter 1, 2, 3 or 4 for your answer.");
        		} else {
        			invalid4 = false;
        		}
...
/* QUESTION 5 **************/
        ...
        //Criterion
        System.out.println("");
        System.out.println("Please type the word that correlates with your preferred answer");
